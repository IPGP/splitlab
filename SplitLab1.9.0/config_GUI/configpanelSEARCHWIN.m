...
tmp=uipanel('Parent',h.panel(3),'Units','pixel','Title','start date',...
    'Position',[113 340 190 50],'TitlePosition','centertop', 'BackgroundColor', [224   223   227]/255 );
...
tmp=uipanel('Parent',h.panel(3),'Units','pixel','Title','end date',...
    'Position',[113 280 190 50],'TitlePosition','centertop', 'BackgroundColor', [224   223   227]/255 );
...
tmpM=uipanel('Parent',h.panel(3),'Units','pixel','Title','Magnitude window',...
    'Position',[15  210 200 50],'TitlePosition','centertop', 'BackgroundColor', [224   223   227]/255 );
