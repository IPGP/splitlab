...
hb = uibuttongroup('Units','pixel','visible','off','Position',[20  120  245 150], 'BackgroundColor', [224   223   227]/255, 'parent',h.panel(11),'Title','Method','SelectionChangedFcn',@configRADIOBUTTON);
hi = uibuttongroup('Units','pixel','visible','off','Position',[20   55  385  60], 'BackgroundColor', [224   223   227]/255, 'parent',h.panel(11),'Title','Polarisation for EV- and RC- method','SelectionChangedFcn',@configRADIOBUTTON);
