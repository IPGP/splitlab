...
hb = uibuttongroup('Units','pixel','visible','off','Position',[20  120  245 150], 'BackgroundColor', [224   223   227]/255, 'parent',h.panel(11),'Title','Method');
hi = uibuttongroup('Units','pixel','visible','off','Position',[20   55  385  60], 'BackgroundColor', [224   223   227]/255, 'parent',h.panel(11),'Title','Polarisation for EV- and RC- method');
hs = uipanel(      'Units','pixel','visible','on', 'Position',[275 120  130 150], 'BackgroundColor', [224   223   227]/255, 'parent',h.panel(11),'Title','Gridsearch parameters');
...
% ppol = uicontrol('Style','PopUpMenu', 'BackgroundColor', [1 1 1],...
%     'String',{'Determine ray-plane from matTaup or straight line','Determine ray-plane from P-polarisation'},...
%     'pos',[20 28 300 18],'parent',h.panel(11),'value',config.geometryOption,...
%     'Callback','config.geometryOption = get(gcbo,''Value'');');
...
uicontrol('Style','popupMenu','String',str,...
    'pos',[30 80 60 20],'HandleVisibility','off',...
    'Value',val,'parent',hs,...
    'BackgroundColor','w',...
...
uicontrol('Style','popupMenu','String',str,...
    'pos',[30 20 60 20],'HandleVisibility','off',...
    'Value',val,'parent',hs,...
    'BackgroundColor','w',...
...
uicontrol('Style','popupMenu','String',str,...
    'pos',[175 pos(4)-85 60 20],'HandleVisibility','off',...
...
uicontrol('Style','text','String','Interpolation method','parent',h.panel(11),...
    'pos',[10 pos(4)-120 150 20])

u2 = uicontrol('Style','radiobutton','String','Minimum Energy',...
    'pos',[10 110 200 20],'parent',hb,'HandleVisibility','off',...
    'Tag','MinE');

u4 = uicontrol('Style','radiobutton','String','Eigenvalue: min(lambda1 * lambda2)',...
    'pos',[10 90 200 20],'parent',hb,'HandleVisibility','off',...
    'Tag','MinL1L2');

u5 = uicontrol('Style','radiobutton','String','Eigenvalue: min(lambda2 / lambda1)',...
    'pos',[10 70 200 20],'parent',hb,'HandleVisibility','off',...
    'Tag','MinL2L1');

u1 = uicontrol('Style','radiobutton','String','Eigenvalue: max(lambda1 / lambda2)',...
    'pos',[10 50 200 20],'parent',hb,'HandleVisibility','off',...
    'Tag','MaxL1L2');

u3 = uicontrol('Style','radiobutton','String','Eigenvalue: max(lambda1)',...
    'pos',[10 30 200 20],'parent',hb,'HandleVisibility','off',...
    'Tag','MaxL1');

u0 = uicontrol('Style','radiobutton','String','Eigenvalue: min(lambda2)',...
...
i1 = uicontrol('Style','radiobutton','String','fixed (based on selected phase; [SG,SH]=[Q,T])',...
    'pos',[10 25 300 20],'parent',hi,'HandleVisibility','off','Tag','fixed');
i2 = uicontrol('Style','radiobutton','String','estimated (from SG/SH-wavelet)',...
    'pos',[10 5 250 20],'parent',hi,'Tag','estimated');




set(hi,'SelectionChangeFcn','global config; config.inipoloption = get(gcbo,''Tag'');');
set(hb,'SelectionChangeFcn','global config; config.splitoption  = get(gcbo,''String'');');
