...
if nargin == 1
    ...
    panels = get(seisvi,'Children');
    radiob = findobj('Tag','radiobuttons');
    
    set(panels(1), 'Visible','On');         % shown content splitoptions
    set(panels(2:10), 'Visible','Off');     % avoid shwoing content of other radiobutton

    uicontrol(...       % can't reference using 'tag' or whatsever, hence hard-coded
        'Style','Radio','String','Split Options',...
        'BackgroundColor','w',...
