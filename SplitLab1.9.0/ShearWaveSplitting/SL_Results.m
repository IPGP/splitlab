...
uicontrol('Units','pixel',...
          ...
          'String', 'Plot',...
          'ToolTipString','Plot individual splitting parameters with respect to the backazimuth.',...
...
uicontrol('Units','pixel',...
          ...
          'String', 'Save Figure',...
          'ToolTipString','Save the figure obtained from the "Plot" button.',...
...
uicontrol('Units','pixel',...
          ...
          'String', 'Stack W&S',...
          'ToolTipString','Find the apparent anisotropy at the station from stacking of the individual energy maps (Wolfe & Silver, 1998).',...
...
uicontrol('Units','pixel',...
          ...
          'String', 'Multichannel',...
          'ToolTipString','Find the the apparent anisotropy at the station from multichannel analysis (Chevrot, 2000).',...
          'Callback',@(hObject,callbackdata)multichannel);
