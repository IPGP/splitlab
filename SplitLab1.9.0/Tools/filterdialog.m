...
hndl(3) = uicontrol('Units','pixel', 'Style','popupmenu','Parent',fig,...
    ...
    'Position',[200 70 45 20], 'String', num2str((1:9)'),...
    'Value',norder);
...
uicontrol('Units','pixel', 'Style','pushbutton','Parent',fig,...
    'Position',[winwidth-70 10 45 25], 'String', 'Cancel',...
    'callback','assignin(''caller'',''key'',0); close(gcbf);')
