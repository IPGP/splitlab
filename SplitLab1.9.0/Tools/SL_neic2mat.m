function varargout=SL_neic2mat(catalogue)
...
switch hbox
    ...
    case 'Update from Server'
        ...
        try
            neic     = urlread(['http://earthquake.usgs.gov/earthquakes/search/'...
...
if isempty(data)
    workbar(1)
    helpdlg('Your catalogue seems to be up to date!', 'Yippie')
    return
end
...
if nargout==0
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% save datebase:
    [FileName,PathName] = uiputfile('*.mat','Save Catalogue', catalogue);
    if ~(FileName==0)
