...
%     Page-Up:        Zoom-in by 20%
%     Page-Down:      Zoom-out by 20%
...
%   outside the axes limits, zoom is relative to the centre of the plot.
%   Note that zooming changes the axes limits, which may cut-off some of
%   the features in the plot.
%
%
% Example 1:
%   t = 0:pi/100:20*pi;
...
elseif nargin==1
    switch option
        ...
        case 'on'
            ...
            if ~isempty(oldKeyPressFcn) && ~strcmp(char(oldKeyPressFcn),'navigateKeyPress');
